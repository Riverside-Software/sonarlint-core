...
public enum SonarLanguage {
  ...
  OPENEDGE("oe", "openedge", "OpenEdge", new String[]{".p", ".w", ".cls" }, "sonar.oe.file.suffixes"),
  OPENEDGE_DB("oedb", "openedge", "OpenEdgeDB", new String[]{".df"}, Constants.NO_PUBLIC_PROPERTY_PROVIDED_FOR_THIS_LANGUAGE),
