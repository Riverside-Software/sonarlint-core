...
public enum SonarLanguage {
  ...
  APEX("apex", SonarPlugin.APEX, "Apex", new String[]{".trigger"}, "sonar.apex.file.suffixes"),
  ...
  OPENEDGE("oe", SonarPlugin.OPENEDGE, "OpenEdge", new String[]{".p", ".w", ".cls" }, "sonar.oe.file.suffixes"),
  OPENEDGE_DB("oedb", SonarPlugin.OPENEDGE, "OpenEdgeDB", new String[]{".df"}, Constants.NO_PUBLIC_PROPERTY_PROVIDED_FOR_THIS_LANGUAGE),
